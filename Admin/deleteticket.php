...
<html>
<head>
	<title>Delete Flight Ticket Information</title>
	<?php include 'nav.php';?>
</head>
<body>
<div class="container" style="padding-bottom: 268px;">
	...
	<div class="row">
		<div class="col-md-12">
			<h2 class="text-center"  style="padding: 20px;">
				Deleting Flight Ticket Information
			</h2>
		</div>
	</div>
	...
	if(isset($_POST['view'])){
		...
		echo "<th>No</th>";
		echo "<th>Image</th>";
		echo "<th style='width:100px;'>Flying From-To</th>";
		...
		foreach ($db->query($sql2) as $rows){
			...
			echo "<td><a href='delete1.php?tickid=$submenuID&tickna=$submenuName&tickdate=$submenuDate&tickdes=$submenuDes&tickimg=$submenuImg&tickp=$submenuPrice' class='btn btn-danger'>Delete</a></td>";
			echo "</tr>";
		}
	}
	echo "</table>";
