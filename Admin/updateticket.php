...
<div class="container" style="padding-bottom: 268px;">
	...
	<div class="row">
		<div class="col-md-12">
			<h2 class="text-center"  style="padding: 20px;">
				Updating Flight Ticket Information
			</h2>
		</div>
	</div>
	...
	if(isset($_POST['view'])){
		...
		foreach ($db->query($sql2) as $rows){
			...
			echo "<td><a href='update1.php?tickid=$submenuID&tickna=$submenuName&tickdate=$submenuDate&tickdes=$submenuDes&tickimg=$submenuImg&tickp=$submenuPrice&orip=$suboriPrice' class='btn btn-danger'>Update</a></td>";
			echo "</tr>";
		}
	}
	echo "</table>";
